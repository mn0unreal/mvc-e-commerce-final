  ...
  public function make_table($cats, $model = null)
  {
    ...
    if (is_array($cats)) {
      foreach ($cats as $cat_row) {
        ...
        $info['category_name'] = $cat_row->category_name;
        ...
        $result .= '
						<td info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" ><a href="#" >' . $cat_row->id . '</a></td>
						<td info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" ><a href="#" >' . $cat_row->description . '</a></td>
						<td info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" ><a href="#" >' . $cat_row->quantity . '</a></td>
						<td info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" ><a href="#" >' . $cat_row->category_name . '</a></td>
						<td info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" ><a href="#" >' . $cat_row->brand_name . '</a></td>
						<td info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" ><a href="#" >' . $cat_row->price . '</a></td>
						<td info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" ><a href="#" >' . date("jS M, Y H:i:s", strtotime($cat_row->date)) . '</a></td>
						<td info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" ><a href="#" ><img src="' . ROOT . $cat_row->image . '" style="width:70px; height:70px;" /></a></td>
<td></td>

<td>

<button info="' . $info . '" onclick="show_edit_product(' . $edit_args . ',event)" class="btn btn-primary btn-xs">
