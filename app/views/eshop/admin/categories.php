      ...
      <table class="table table-striped table-advance table-hover">
        ...
        <div class="add_new hide">
          ...
          <form class="form-horizontal style-form" method="post">
            ...
            <button type="button" class="btn btn-primary" onclick="collect_data(event)"
        ...
        <div class="edit_category hide">
          ...
          <form class="form-horizontal style-form" method="post">
            ...
            <button type="button" class="btn btn-warning" onclick="show_edit_category(0,'',event)"
              style="position:absolute;bottom:10px; left:10px;">Cancel</button>
            <button type="button" class="btn btn-primary" onclick="collect_edit_data(event)"
              style="position:absolute;bottom:10px; right:10px;">Save</button>
