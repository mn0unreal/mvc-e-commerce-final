      ...
      <form method="get">
        <table class="my-table table table-condensed">
          <tr>
            <th>Description</th>
            <td>
              <input value="<?php Search::get_sticky('textbox', 'description') ?>" autofocus="true" type="text"
                class="form-control" name="description" placeholder="Type what to search for">
            </td>
            <th>Category</th>
            <td>
          ...
          <tr>
            ...
            <td>
              <div class="form-inline">
                <label>Min:</label>
                <input value="<?php Search::get_sticky('number', 'min-price') ?>" class="form-control" type="number"
                  step="0.01" name="min-price">
                <label>Max:</label>
                <input value="<?php Search::get_sticky('number', 'max-price') ?>" class="form-control" type="number"
                  step="0.01" name="max-price">
              </div>
            </td>
            <th>Quantity</th>
            <td>
              <div class="form-inline">
                <label>Min:</label>
                <input class="form-control" type="number" value="<?php Search::get_sticky('number', 'min-qty') ?>"
                  step="1" name="min-qty">
                <label>Max:</label>
                <input class="form-control" type="number" value="<?php Search::get_sticky('number', 'max-qty') ?>"
                  step="1" name="max-qty">
              </div>
            </td>
          </tr>
        ...
        <div class="add_new add_edit_panel hide">
          ...
          <form class="form-horizontal style-form" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input id="price" name="price" type="number" placeholder="0.00" step="0.01" class="form-control"
                  required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input id="image" name="image" type="file"
                  onchange="display_image(this.files[0],this.name,'js-product-images-add')" class="form-control"
                  required>
              </div>
            </div>
            ...
            <button type="button" class="btn btn-warning" onclick="show_add_new(event)"
              style="position:absolute; left:10px;">Close</button>
            <button type="button" class="btn btn-primary" onclick="collect_data(event),window.location.reload()"
              style="position:absolute; right:10px;">Save</button>
        ...
        <div class="edit_product add_edit_panel hide">
          ...
          <form class="form-horizontal style-form" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select id="edit_brand" name="brand" class="form-control" required>
                  <option></option>
                  <?php if (is_array($brands)): ?>
                    <?php foreach ($brands as $bran): ?>

                      <option value="<?= $bran->id ?>"><?= $bran->brand ?></option>
                    <?php endforeach; ?>
                  <?php endif; ?>
                </select>
              </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 col-sm-2 control-label">Price:</label>
              <div class="col-sm-10">
                <input id="edit_price" name="price" type="number" placeholder="0.00" step="0.01" class="form-control"
                  required>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 col-sm-2 control-label">Image:</label>
              <div class="col-sm-10">
                <input id="edit_image" name="image" type="file"
                  onchange="display_image(this.files[0],this.name,'js-product-images-edit')" class="form-control"
                  required>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 col-sm-2 control-label">Image2 (optional):</label>
              <div class="col-sm-10">
                <input id="edit_image2" name="image2" type="file"
                  onchange="display_image(this.files[0],this.name,'js-product-images-edit')" class="form-control">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 col-sm-2 control-label">Image3 (optional):</label>
              <div class="col-sm-10">
                <input id="edit_image3" name="image3" type="file"
                  onchange="display_image(this.files[0],this.name,'js-product-images-edit')" class="form-control">
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 col-sm-2 control-label">Image4 (optional):</label>
              <div class="col-sm-10">
                <input id="edit_image4" name="image4" type="file"
                  onchange="display_image(this.files[0],this.name,'js-product-images-edit')" class="form-control">
              </div>
            </div>
            <br>
            ...
            <button id="cancel" type="button" class="btn btn-warning" onclick="show_edit_product(0,'',false)"
              style="position:absolute; left:10px;">Cancel</button>
            <button id="save" type="button" class="btn btn-primary"
              onclick="collect_edit_data(event),window.location.reload()"
              style="position:absolute; right:10px;">Save</button>
