            ...
            <div class="col-sm-8 clearfix">
              <div class="bill-to">
                ...
                <div class="form-one">
                  ...
                  <input name="address1" value="<?= $address1 ?>" class="form-control" type="text"
                    placeholder="Address 1 *" autofocus="autofocus" required><br>
                  <input name="address2" value="<?= $address2 ?>" class="form-control" type="text"
                    placeholder="Address 2"><br>
                  <input name="postal_code" value="<?= $postal_code ?>" class="form-control" type="text"
                ...
                <div class="form-two">
                  ...
                  <input name="home_phone" value="<?= $home_phone ?>" class="form-control" type="text"
                    placeholder="Home Phone"><br>
                  <input name="mobile_phone" value="<?= $mobile_phone ?>" class="form-control" type="text"
                    placeholder="Mobile Phone *" required><br>
                  <br>
