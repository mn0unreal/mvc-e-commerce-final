              ...
              <ul class="nav nav-pills">
                ...
                <?php if (isset($data['user_data'])): ?>
                  ...
                  <?php if (isset($data['user_data']) && $data['user_data']->rank == 'admin'): ?>
                    <li><a href="<?= ROOT ?>admin" style="font-size:12px;color:#fe980f;">Dashboard</a></li>
                  <?php endif; ?>
          ...
          <div class="col-sm-6">
            <div class="social-icons pull-right">
              <ul class="nav navbar-nav">
                ...
                <li><a target="_new" href="<?= Settings::instagram_link() ?>"><i class="fa fa-instagram"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li class="dropdown"><a href="<?= ROOT ?>shop"
                    class="<?= $page_title == "Shop" ? "active" : ""; ?>">Shop</a></li>
                <li class="dropdown"><a href="<?= ROOT ?>blog"
                    class="<?= $page_title == "Blog" ? "active" : ""; ?>">Blog</a></li>
                <li><a href="<?= ROOT ?>contact-us"
                    class="<?= $page_title == "Contact-us" ? "active" : ""; ?>">Contact</a></li>
              </ul>
            </div>
          </div>
