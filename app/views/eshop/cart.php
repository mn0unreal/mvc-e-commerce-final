...
<section id="cart_items" style="margin-top: -10px;">
  <div class="container">
    <div class="breadcrumbs">
      <ol class="breadcrumb">
        <li> <a style="all: unset; cursor: pointer; " href="<?= ROOT ?>">Home</a></li>
        <li class="active"><a style="margin-left:5px; " href="#">Shopping Cart</a></li>
      </ol>
    </div>
              ...
              <tr>
                ...
                <td class="cart_quantity">
                  <div class="cart_quantity_button">
                    ...
                    <input oninput="edit_quantity(this.value,'<?= $row->id ?>')" class="cart_quantity_input" type="text"
                      name="quantity" value="<?= $row->cart_qty ?>" autocomplete="off" size="2">
                ...
                <td class="cart_delete">
                  <a class="cart_quantity_delete" delete_id="<?= $row->id ?>"
                    ...
                    href="<?= ROOT ?>add_to_cart/remove/<?= $row->id ?>"><i class="fa fa-times"></i></a>
                </td>
              </tr>
